...
return this.each(function(){
    ...
    if (_34) {
        ...
        _34 = $.data(this, "switchbutton", {
            options: $.extend({}, $.fn.switchbutton.defaults, $.fn.switchbutton.parseOptions(this), _32),
...
return jq.each(function(){
    ...
    $.fn.switchbutton.parseOptions = function (_3a) {
        var t = $(_3a);
        return $.extend({}, $.parser.parseOptions(_3a, ["onText", "offText", "handleText", {
            handleWidth: "number",
            reversed: "boolean"
