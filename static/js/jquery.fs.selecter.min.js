...
(function (e, t) {
    ...
    function c(t, r) {
        if (!t.hasClass("selecter-element")) {
            ...
            var i = t.find("[selected]").not(":disabled"), o = t.find("option").index(i);
            if (!r.multiple && r.label !== "") {
                t.prepend('<option value="" class="selecter-placeholder" selected>' + r.label + "</option>");
                if (o > -1) {
                    o++
                }
            } else {
            ...
            var u = t.find("option, optgroup"), a = u.filter("option");
            if (!i.length) {
                i = a.eq(0)
            }
            var f = o > -1 ? o : 0, l = r.label !== "" ? r.label : i.text(), c = "div";
            r.tabIndex = t[0].tabIndex;
            t[0].tabIndex = -1;
            var d = "", v = "";
            v += "<" + c + ' class="selecter ' + r.customClass;
            if (s) {
                v += " mobile"
            } else if (r.cover) {
                v += " cover"
            ...
            v += '" tabindex="' + r.tabIndex + '">';
            v += "</" + c + ">";
            if (!r.multiple) {
                d += '<span class="selecter-selected">';
                d += e("<span></span>").text(A(l, r.trim)).html();
                d += "</span>"
            }
            d += '<div class="selecter-options">';
            d += "</div>";
            t.addClass("selecter-element").wrap(v).after(d);
            var g = t.parent(".selecter"), y = e.extend({
                $select: t,
                $allOptions: u,
                $options: a,
                $selecter: g,
                $selected: g.find(".selecter-selected"),
                $itemsWrapper: g.find(".selecter-options"),
                index: -1,
                guid: n++
            }, r);
            h(y);
            ...
            if (e.fn.scroller !== undefined) {
                y.$itemsWrapper.scroller()
            }
            y.$selecter.on("touchstart.selecter", ".selecter-selected", y, p).on("click.selecter", ".selecter-selected", y, m).on("click.selecter", ".selecter-item", y, w).on("close.selecter", y, b).data("selecter", y);
            y.$select.on("change.selecter", y, E);
            if (!s) {
                y.$selecter.on("focusin.selecter", y, S).on("blur.selecter", y, x);
                y.$select.on("focusin.selecter", y, function (e) {
    ...
    function h(t) {
        ...
        for (var s = 0, o = t.$allOptions.length; s < o; s++) {
            ...
            if (u[0].tagName === "OPTGROUP") {
                ...
                if (u.hasClass("selecter-placeholder")) {
                    n += " placeholder"
                }
                if (u.is(":selected")) {
                    n += " selected"
    ...
    function d(e) {
        var t = e.data, n = e.originalEvent;
    ...
    function g(e) {
        ...
        if (!t.$selecter.hasClass("open")) {
            var n = t.$selecter.offset(), r = u.outerHeight(), i = t.$itemsWrapper.outerHeight(true), s = t.index >= 0 ? t.$items.eq(t.index).position() : {
                left: 0,
                top: 0
            };
            if (n.top + i > r) {
    ...
    function T(t) {
        ...
        if (t.keyCode === 13) {
            ...
            t.preventDefault();
            t.stopPropagation();
            var r = n.$items.length - 1, s = n.index < 0 ? 0 : n.index;
            if (e.inArray(t.keyCode, i ? [38, 40, 37, 39] : [38, 40]) > -1) {
                ...
                var o = String.fromCharCode(t.keyCode).toUpperCase(), u, a;
    ...
    function N(e, t) {
        var n = t.$items.eq(e), r = n.hasClass("selected"), i = n.hasClass("disabled");
        if (!i) {
            if (t.multiple) {
                if (r) {
    ...
    function C(t) {
        var n = t.$items.eq(t.index), r = t.index >= 0 && !n.hasClass("placeholder") ? n.position() : {left: 0, top: 0};
        if (e.fn.scroller !== undefined) {
            t.$itemsWrapper.scroller("scroll", t.$itemsWrapper.find(".scroller-content").scrollTop() + r.top, 0).scroller("reset")
        } else {
            t.$itemsWrapper.scrollTop(t.$itemsWrapper.scrollTop() + r.top)
        }
    }
    ...
    var n = 0, r = t.navigator.userAgent || t.navigator.vendor || t.opera, i = /Firefox/i.test(r), s = /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(r), o = i && s, u = null;
    var a = {
        callback: e.noop,
        cover: false,
        customClass: "",
