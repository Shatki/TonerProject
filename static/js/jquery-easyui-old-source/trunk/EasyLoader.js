(function () {
    var _1 = {
        ...
        dialog: {js: "jquery.dialog.js", css: "dialog.css", dependencies: ["window"]},
        ...
        tabs: {js: "jquery.tabs.js", css: "tabs.css"},
        ...
        combobox: {js: "jquery.combobox.js", css: "combobox.css", dependencies: ["validatebox"]},
        combotree: {js: "jquery.combotree.js", css: "combotree.css", dependencies: ["tree", "validatebox"]},
        validatebox: {js: "jquery.validatebox.js", css: "validatebox.css"},
        numberbox: {js: "jquery.numberbox.js", dependencies: ["validatebox"]},
        tree: {js: "jquery.tree.js", css: "tree.css"},
        datebox: {js: "jquery.datebox.js", css: "datebox.css", dependencies: ["calendar"]},
    ...
    EasyLoader = {
        modules: _1, base: ".", theme: "default", css: true, locale: null, timeout: 2000, load: function (_1b, _1c) {
            if (/\.css$/i.test(_1b)) {
                if (/^http/i.test(_1b)) {
                    _a(_1b, _1c);
                } else {
